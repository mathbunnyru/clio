...
struct LedgerCacheTest : util::prometheus::WithPrometheus, NoLogServiceFixture {
    LedgerCache cache;
};
...
struct LedgerCachePrometheusMetricTest : util::prometheus::WithMockPrometheus, NoLogServiceFixture {
    LedgerCache cache;
};
